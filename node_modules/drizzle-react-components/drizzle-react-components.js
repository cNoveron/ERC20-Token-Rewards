...
var ContractData = function (_Component) {
  ...
  function ContractData(props, context) {
    ...
    var method = _this.contracts[_this.props.contract].methods[_this.props.method];
    var methodArgs = _this.props.methodArgs ? _this.props.methodArgs : [];
    _this.props.dataKey = (_this$contracts$_this = _this.contracts[_this.props.contract].methods[_this.props.method]).cacheCall.apply(_this$contracts$_this, _toConsumableArray(methodArgs));
    ...
    value: function componentDidUpdate(prevProps) {
      if(this.props.methodArgs){
        if(JSON.stringify(this.props.methodArgs) !== JSON.stringify(prevProps.methodArgs)){
            console.log(JSON.stringify(this.props.methodArgs),JSON.stringify(prevProps.methodArgs))
