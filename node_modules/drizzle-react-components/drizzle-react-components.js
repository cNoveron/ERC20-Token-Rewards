...
var ContractData = function (_Component) {
    ...
    function ContractData(props) {
        ...
        _this.state = {
          dataKey: (_this$method = _this.method).cacheCall.apply(_this$method, _toConsumableArray(methodArgs))
        };
        return _this;
    }
      ...
      value: function componentDidUpdate(prevProps) {
        if (this.props.methodArgs) {
          ...
          if (JSON.stringify(this.props.methodArgs) !== JSON.stringify(prevProps.methodArgs)) {
            console.log(JSON.stringify(this.props.methodArgs))

            var method = this.props.drizzle.contracts[this.props.contract].methods[this.props.method];
            this.setState({
