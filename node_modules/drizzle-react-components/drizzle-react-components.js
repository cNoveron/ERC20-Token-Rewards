...
var ContractData = function (_Component) {
  ...
  function ContractData(props, context) {
    ...
    _this.state = { dataKey: _this.dataKey };
    return _this;
  }
  ...
  _createClass(ContractData, [{
    ...
    value: function componentDidUpdate(prevProps) {
      if(this.props.methodArgs){
        if (this.props.methodArgs[0] !== prevProps.methodArgs[0]) {
            console.log("typeof this.props.methodArgs : "+typeof this.props.methodArgs[0])
            console.log(this.props.methodArgs[0])
            console.log("typeof prevProps.methodArgs : "+typeof prevProps.methodArgs[0])
            console.log(prevProps.methodArgs[0])
            var method = this.contracts[this.props.contract].methods[this.props.method];
            var methodArgs = this.props.methodArgs ? this.props.methodArgs : [];
            this.dataKey = method.cacheCall.apply(method, _toConsumableArray(methodArgs));
            this.setState({ dataKey: this.dataKey });
        }
      }
    }
  }, {
