...
var ContractData = function (_Component) {
	...
	function ContractData(props) {
		...
		_this.methodArgs = _this.props.methodArgs ? _this.props.methodArgs : [];
		_this.state = { dataKey: null };
		return _this;
	}
	...
	_createClass(ContractData, [{
		...
		value: function componentDidMount() {
			...
			var dataKey = (_props$drizzle$contra = this.props.drizzle.contracts[this.props.contract].methods[this.props.method]).cacheCall.apply(_props$drizzle$contra, _toConsumableArray(this.methodArgs));
